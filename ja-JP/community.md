...
RustaceanはMozillaのIRCネットワークirc.mozilla.orgで多数の友好的でトラフィックの多い [IRC] チャネルを運営しています。
...
- [#rust-beginners][beginners_irc] はRustに初めての人のためのチャネル。#rustよりもトラフィックは少ない
...
* [言語設計チーム][language_team]は言語の新機能の設計について責任を担います。

* [ライブラリチーム][library_team]はRustの標準ライブラリ、rust-langクレート、規則について責任を担います。

* [コンパイラチーム][compiler_team]はコンパイラ内部や最適化について責任を担います。

* [ツール及び基盤チーム][tool_team]は[Cargo]、[rustup]、[rustfmt]などのオフィシャルなツール、及びそのCI基盤について責任を担います。

[Cargo]: https://crates.io
[rustup]: https://www.rustup.rs
[rustfmt]: https://github.com/rust-lang-nursery/rustfmt

* [コミュニティチーム][community_team]はイベントの調整、広報、商用ユーザ、技術教材、展示会について責任を担います。また、問い合わせ先が不明な問い合わせの案内役もします。

* [モデレーションチーム][mod_team] は[行動規範][coc]を守るための援助について責任を担います。

* [ドキュメントチーム][doc_team]はRustに素晴しいドキュメントが付くことを保障するのに責任を担います。
...
- [メインレポジトリ][github]と[イシュートラッカ][issue_tracking]は実装作業の前線です。
  レビュワーは友好的で新人に教育的であろうと努力していま。だから気兼ねなくプルリクエストをオープンして下さい！

- [RFCレポジトリ][rfcs]では「意見募集(Request for Comment)」のプロセスをトラックしています。
  RFCはRustのコミュニティとチームが言語や公式ライブラリ、ツールについての新しい機能の提案について合意に達するための主な経路です。
